...
def friction_factor(Re):
    if Re < 2300:
        return 64.0 / Re, "🟢 층류 (Laminar)"
    if Re < 4000:
        f_l = 64.0 / 2300.0
        f_t = _colebrook_smooth(4000.0)
        t   = (Re - 2300.0) / 1700.0
        return f_l + t * (f_t - f_l), "🟡 전이 (Transitional)"
    return _colebrook_smooth(Re), "🔴 난류 (Turbulent)"
